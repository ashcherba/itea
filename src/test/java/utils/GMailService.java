...
public class GMailService {
    ...
    String user = "aashcherba.qa@gmail.com";
    String pass = "Anna@1994";

    private volatile boolean isMessageReceived = false;
    private volatile String messageString;

    public static void main(String[] args) {
        String messageSubjectPartial = "Itea, here's the link to reset your password";
        String messageToPartial = "aashcherba.qa@gmail.com";
        String messageFromPartial = "LinkedIn <security-noreply@linkedin.com>";
